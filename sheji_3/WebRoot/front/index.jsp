...
<!-- fav and touch icons -->
    <link rel="shortcut icon" href="front/themes/images/ico/favicon.ico">
...
<div id="carouselBlk">
	<div id="myCarousel" class="carousel slide">
		...
		<!-- 循环显示顶部的广告位 -->
		<c:forEach items="${aList }" var="ad" varStatus="vs">
		 <c:if test="${vs.count==1 }"><div class="item active"></c:if>
		<c:if test="${vs.count>1 }"><div class="item"></c:if>
		
		  <div class="container">
			<a href="../InitController/initRegister.do"><img style="width:100%" src="../pictures/${ad.name }" alt="special offers"/></a>
...
<!-- Sidebar end=============================================== -->
		<%-- <div class="span9">		
			...
			<div class="carousel-inner">
			<!-- 特色商品展示 ,一个ul包含4个商品,1组为一个div-->
			<c:forEach var="i" begin="1" end="${fListSize/4 }" step="1">
			<c:if test="${i==1 }"><div class="item active"></c:if>
			<c:if test="${i>1 }"><div class="item"></c:if>
			  <ul class="thumbnails">
			  <c:forEach items="${fList }" var="good" begin="${i*4-3 }" end="${i*4 }" step="1">
			  <li class="span3">
				  <div class="thumbnail">
				  <i class="tag"></i>
		...
		<div class="span9">		
			...
			<div class="carousel-inner">
			<!--0-3 4-7  -->
			  <c:forEach var="i" begin="0" end="${fListSize/4-1 }" step="1">
			<c:if test="${i==0 }"><div class="item active"></c:if>
			<c:if test="${i>0 }"><div class="item"></c:if>
			  <ul class="thumbnails">
			  <!-- 遍历组内的4个商品 -->
				<c:forEach items="${fList }" var="good" begin="${i*4 }" end="${i*4+3 }" step="1">
			  <li class="span3">
				  <div class="thumbnail">
				  <i class="tag"></i>
					<a href="product_details.html"><img src="../pictures/${good.pictureName }" alt=""></a>
		...
		<!-- 显示最新的6个商品 -->
			  ...
			  <li class="span3">
				  <div class="thumbnail">
					<a  href="../GoodController/initDetails.do?id=${good.id }"><img src="../pictures/${good.pictureName }" alt=""/></a>
					<div class="caption">
					  <h5>${good.name }</h5>
					  <p> 
						${good.description}
					  </p>
					  <h4 style="text-align:center"><a class="btn" href="../GoodController/initDetails.do?id=${good.id }"> <i class="icon-zoom-in"></i></a> <a class="btn" href="../CartController/insertCart.do?userId=${sessionScope.user.id}&goodId=${good.id}&cartNumber=1">Add to <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#">${good.price }</a></h4>
					</div>
				  </div>
				</li>
			  </c:forEach>
