...
<html>
  <head>
	...
	-->
	<link rel="stylesheet" href="front/css/tasp.css" />
	<link href="front/css/orderconfirm.css" rel="stylesheet" />
	<style>
#page{width:auto;}
...
<ul id="address-list" class="address-list">
 ...
 <label for="addrId_674944241" class="user-address">
         ${sessionScope.address.province } ${sessionScope.address.city }  ${sessionScope.user.address } (${sessionScope.user.personName } 收) <em>${sessionScope.user.tel }</em>
   </label>
...
<c:forEach items="${cart.goodList }" var="good">
 ...
 <td class="s-title">
     <img src="pictures/${good.pictureName }" class="itempic"><span class="title J_MakePoint" data-point-url="http://log.mmstat.com/buy.1.5">${good.name }</span></a>
...
<img src="http://img03.taobaocdn.com/tps/i3/T1bnR4XEBhXXcQVo..-14-16.png"/>
 ...
 <td class="s-price">
  ...
  <span class='price '>
 <em class="style-normal-small-black J_ItemPrice"  >${good.price }</em>
  </span>
<input type="hidden" name="costprice" value="630.00" class="J_CostPrice" />
</td>
 <td class="s-amount" data-point-url="">
         <input type="hidden" class="J_Quantity" value="1" name="19614514619_31175333266_35612993875_quantity"/>${good.cartNumber }
 ...
 <td class="s-total">
   ...
   <span class='price '>
 <em class="style-normal-bold-red J_ItemTotal "  >${good.price*good.cartNumber }</em>
  </span>
...
<tr class="shop-total blue-line">
 ...
 <span>&yen;</span><em class="style-middle-bold-red J_ShopTotal"  >${requestScope.cart.realTotal }</em>
  </span>
...
<div class="J_AddressConfirm address-confirm">
 ...
 <span>&yen;</span><em class="style-large-bold-red"  id="J_ActualFee"  >${requestScope.cart.realTotal }</em>
  </span>
</div>

  <ul >
 <li><em>寄送至:</em><span id="J_AddrConfirm" style="word-break: break-all;">
   ${sessionScope.address.province } ${sessionScope.address.city }  ${sessionScope.address.address }
   </span></li>
 <li><em>收货人:</em><span id="J_AddrNameConfirm">${sessionScope.user.personName }${sessionScope.user.tel } </span></li>
 </ul>
     </div>
 </div>
         <a href="#"
 ...
 data-point-url="">返回购物车</a>
       <a id="J_Go" class=" btn-go"  data-point-url=""  tabindex="0" title="点击此按钮，提交订单。" href="OrderController/insertOrderAndDetail.do?id=${sessionScope.user.id }">提交订单<b class="dpl-button"></b></a>
  </div>
 </div>
