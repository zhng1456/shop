...
<!-- Sidebar end=============================================== -->
	...
	<div class="row">	  
            ...
            <a href="themes/images/products/large/f1.jpg" title="Fujifilm FinePix S2950 Digital Camera">
				<img src="../pictures/${requestScope.good.pictureName }" style="width:100%" alt=""/>
            </a>
			<div id="differentview" class="moreOptopm carousel slide">
                <div class="carousel-inner">
                  <div class="item active">
                   <a href="../pictures/${requestScope.good.pictureName }"> <img style="width:29%" src="../pictures/${requestScope.good.pictureName }" alt=""/></a>
			...
			<div class="span6">
				...
				<hr class="soft"/>
				<h4>库存:${requestScope.good.number }</h4>
				<h4>所属类别:${requestScope.good.type.name }</h4>
            ...
            <button width="100px" id="commentButton" onclick="addComment(${requestScope.good.id },${sessionScope.user.id },'${sessionScope.user.personName }')">添加评论</button>
